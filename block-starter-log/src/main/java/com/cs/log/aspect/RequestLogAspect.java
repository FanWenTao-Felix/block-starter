...
@ConditionalOnProperty(value = "block.log.request.enabled", havingValue = "true", matchIfMissing = true)
public class RequestLogAspect {
	 ...
	 */
	@Around(
		"execution(!static com.cs.core.tool.api.R *(..)) && " +

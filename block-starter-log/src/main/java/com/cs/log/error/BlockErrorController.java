 ...
 * @blame csz
 */
public class BlockErrorController extends BasicErrorController {

	public BlockErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {

package com.cs.develop.support;
...
import com.cs.develop.constant.DevelopConstant;
import lombok.Data;
...
public class BlockCodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "block-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "com.cs.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"block_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"block_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("com.cs.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("com.cs.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("com.cs.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.cs.core.boot.ctrl.BlockController");
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/block-ops/block-develop" : packageDir) + "/src/main/java";
	}
